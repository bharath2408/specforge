# Review Report: 004-smart-brainstorm-triggers
...
- **[MEDIUM]** Entity/entities not referenced in scenarios: ToolSelection, SpecSignals, ToolOverride.
...
5. Make scenario clauses more descriptive (at least 5 words each).
